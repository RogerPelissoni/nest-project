...
-- AddForeignKey
ALTER TABLE `profile_permission` ADD CONSTRAINT `profile_permission_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
